...
def verify_terraform_setup(data):
    ...
    try:
        ...
        required_keys = ["vpc_id", "public_subnet_1_id", "public_subnet_2_id", "igw_id", "route_table_id", "security_group_id", "eks_cluster_id", "eks_cluster_depend", "eks_cluster_endpoint", "eks_node_group_id", "eks_node_group_depend", "kubectl_server_instance_id"]
        ...
        if all(key in outputs for key in required_keys):
            terraform_outputs = {
                ...
                "eks_cluster_depend": outputs["eks_cluster_depend"]["value"],
                "eks_cluster_endpoint": outputs["eks_cluster_endpoint"]["value"],
                "eks_node_group_id": outputs["eks_node_group_id"]["value"],
                "eks_node_group_depend": outputs["eks_node_group_depend"]["value"],
...
def main():
    ...
    overall = {"data": []}
    data = []
    terraform_outputs = verify_terraform_setup(data)
